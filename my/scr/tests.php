...
//   $firstName = "aviad";//htmlspecialchars($_REQUEST['firstName']);     	 
//   $lastName  = "blu";//htmlspecialchars($_REQUEST['lastName']);     		 
//   $email     = "aviadblu@gmail.com";//htmlspecialchars($_REQUEST['email']);                    
//   $address1  = "add1";//htmlspecialchars($_REQUEST['address1']);
//   $address2  = "add2";//htmlspecialchars($_REQUEST['address2']);
//   $city      = "city";//htmlspecialchars($_REQUEST['city']);
//   $state     = "state";//htmlspecialchars($_REQUEST['state']);
//   $country   = "IL";//htmlspecialchars($_REQUEST['country']);
//   $zipCode   = "77623";//htmlspecialchars($_REQUEST['zipcode']);
//   $phone     = '0542092666';//htmlspecialchars($_REQUEST['phone']);
 ...
 $phone = "411-555-1212";
   ...
   // the <web-info> element supposed to hold customers' information (IP, browser type etc) 
    ...
    <shopper xmlns=\"http://ws.plimus.com\">
          ...
          <web-info> 
                <ip>$ip</ip>
                <remote-host>$remote_host</remote-host>
   ...
   // echo $xmlToSend;
    ...
    $credentials = 'API_1387895633049988238276:BlueSnap1wh'; 
