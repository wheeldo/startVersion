<div class="loader_afterload {{finish_load}}" ng-init="setEditScreenFunctions()">
    <div class="breadcrumbs">
        ...
        <div class="arrow"></div>
        <div>Edit '{{copyData.appCopyName}}' Game</div>
        <div class="page_action"> <!--floating-->
            <div class="actions_wrapper">
<!--                <button type="button" class="system_button blue_button save_edit" style="float:left;" ng-click="saveData()">Preview</button>-->
                <button type="button" class="system_button blue_button save_edit" style="float:left;" ng-click="previewGame()" ng-show="appData.preview=='1'&&copyData.appCopyTerminate">Preview</button>
        ...
        <div class="switch" ng-show="copyData.appCopyTerminate==0"><a href='/#/report/{{appData.appID}}/{{copyData.appCopyID}}'>Switch to game report</a></div>
        <br class="clr" />
    </div>
...
<!--        <button type="button" class="system_button green_button" style="float:right;" id="saveAndPublishButton" ng-show="copyData.appCopyTerminate" ng-click="saveAndPublish()">Save and Publish Game</button>
