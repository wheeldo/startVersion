...
class App extends DataStructure {
	...
	/**
	 * returns an array of data of apps and joining any tables as specified
	 ...
	 */
	public static function appArray($where = '',$whereVals,$orderby = '',array $join = null){
